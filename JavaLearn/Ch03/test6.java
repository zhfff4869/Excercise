...
class model6 {
    static double[][] A = { { 0.83, 0.84, 0.95, 0.96,0.94,0.93,0.99,0.97,0.99 }};

    static double[][] B = { { 0.86, 0.96, 0.78, 1 ,0.84,0.95,0.65,0.94,0.86}, { 0.99, 0.99, 0.89, 0.9,0.93,0.92,0.88,0.77,0.99 } };
    ...
    public static void match() {
        ...
        for (int k = 0; k < score.length; k++) {
            for (int i = 0; i < score[k].length; i++) {
                System.out.printf("B%d of model A%d: score is %f\n", k+1,i + 1, score[k][i]);
